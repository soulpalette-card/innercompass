...
CULT.MONSTERS = [
  ...
  { id: 'boar', name: '铁鬃野猪', minRealm: 0, tier: 'normal',
  ...
  { id: 'elite_fox', name: '九尾妖狐', minRealm: 1, tier: 'elite',
  ...
  { id: 'boss_jindan', name: '金丹魔君', minRealm: 2, tier: 'boss',
  ...
  { id: 'boss_yuanying', name: '元婴期魔尊', minRealm: 3, tier: 'boss',
